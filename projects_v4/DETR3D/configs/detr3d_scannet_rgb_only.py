...
model = dict(
    ...
    data_preprocessor=dict(
        type='PointAnchorDataPreprocessor',
    ...
    pts_bbox_head=dict(
        ...
        # Grid anchors cover ScanNet center P1-P99; queries learn residual offsets.
        anchor_grid_size=[15, 15, 4],
        anchor_center_range=[-3.1, -4.1, 0.1, 3.1, 4.1, 1.95],
        center_offset_scale=[3.0, 6.0, 2.0],
        size_prior=[0.619, 0.632, 0.820],
        max_detections=100,
...
train_pipeline = [
    ...
    dict(
        type='LoadPointCloudAnchors', num_anchors=900, voxel_size=0.20,
        cache_dir=data_root + 'point_anchor_cache_900'),
...
custom_hooks = [
    dict(type='PerSceneResultDumpHook'),
]
